...
class SceneManager:
    ...
    CONTROL_ACTORS_ACTION = ControlActorsAction(MOUSE_SERVICE, AUDIO_SERVICE)
    ...
    def _add_pads(self, cast):
        ...
        cast.add_actor("pad1", Pad(RED_PAD_POSITION, PAD_SIZE, RED, RED_PAD_SOUND))
        cast.add_actor("pad2", Pad(BLUE_PAD_POSITION, PAD_SIZE, BLUE, BLUE_PAD_SOUND))
        cast.add_actor("pad3", Pad(GREEN_PAD_POSITION, PAD_SIZE, GREEN, GREEN_PAD_SOUND))
        cast.add_actor("pad4", Pad(YELLOW_PAD_POSITION, PAD_SIZE, YELLOW, YELLOW_PAD_SOUND))

    def _add_sequence(self, cast):
        cast.clear_actors("beat_sequence")
        cast.add_actor("beat_sequence", BeatSequence())
    # ----------------------------------------------------------------------------------------------
    # scripting methods
    # ----------------------------------------------------------------------------------------------
